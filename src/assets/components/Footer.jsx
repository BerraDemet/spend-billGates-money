export default function Footer({ purchasedProducts, total }) {
  return (
    <div className="w-full bg-white flex flex-col items-center py-4 px-96 border border-gray-200 shadow-md mt-2">
